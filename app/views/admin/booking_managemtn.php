...
<body class="flex min-h-screen">
    ...
    <aside class="w-64 bg-slate-800 text-white p-6 shadow-lg hidden md:block">
        ...
        <nav class="space-y-2">
            ...
            <a href="admin-booking-management.html" class="block px-4 py-2 bg-slate-700 rounded-lg font-medium hover:bg-slate-600 transition-colors">Booking Management</a>
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-semibold text-gray-700">Customer Bookings</h2>
                <div class="relative">
                    <input type="text" placeholder="Search by PNR or name..." class="pl-10 pr-4 py-2 rounded-lg border border-gray-300">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">TG660</td>
